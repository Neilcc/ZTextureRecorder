...
package com.zcc.glrender.grafika.gles;
...
public class Texture2dProgram {
     ...
     * <p>
     * On queryExit, the texture will be bound.
     */
    public int createTextureObject(ProgramType programType) {
    ...
    public void setKernel(float[] values, float colorAdj) {
        ...
        //ALog.d(TAG, "filt kernel: " + Arrays.toString(mKernel) + ", adj=" + colorAdj);
    }
    ...
    public void setTexSize(int width, int height) {
        ...
        //ALog.d(TAG, "filt size: " + width + "x" + height + ": " + Arrays.toString(mTexOffset));
    }
